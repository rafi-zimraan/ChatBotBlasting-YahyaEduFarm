...
const DEFAULT_FAQ_DM = [
    ...
    { id: 26, keyword: 'halo',                 answer: 'Halo kak! 👋 Senang sekali bisa ngobrol sama kakak 😊\n\nAda rencana untuk berkunjung ke YahyaEduFarm? Kami adalah agrowisata edukasi berbasis Masjid Ismuhu Yahya di Kalimantan Barat — tempatnya asri, cocok untuk keluarga, sekolah, dan komunitas. Ada program wisata panen, edukasi hidroponik, outbound, dan gathering.\n\nSilakan tanya apa saja ya kak, dengan senang hati kami bantu 🙏', enabled: true },
    { id: 27, keyword: 'selamat pagi',         answer: 'Selamat pagi kak! 🌤️ Semoga hari kakak penuh berkah 😊\n\nAda rencana untuk berkunjung ke YahyaEduFarm? Yuk lihat program kami: wisata panen, edukasi hidroponik, outbound, dan gathering — semua berbasis Masjid Ismuhu Yahya di Kalimantan Barat.\n\nAda yang bisa kami bantu hari ini? 🙏', enabled: true },
    { id: 28, keyword: 'selamat siang',        answer: 'Selamat siang kak! ☀️ Semoga hari kakak menyenangkan 😊\n\nAda rencana untuk berkunjung ke YahyaEduFarm? Yuk lihat program kami: wisata panen, edukasi hidroponik, outbound, dan gathering — semua berbasis Masjid Ismuhu Yahya di Kalimantan Barat.\n\nAda yang bisa kami bantu? 🙏', enabled: true },
    { id: 29, keyword: 'selamat malam',        answer: 'Selamat malam kak! 🌙 Terima kasih sudah menghubungi YahyaEduFarm 😊\n\nAda rencana untuk berkunjung? Kami punya program wisata panen, edukasi hidroponik, outbound, dan gathering — berbasis Masjid Ismuhu Yahya di Kalimantan Barat.\n\nSilakan tanya-tanya dulu ya kak, dengan senang hati 🙏', enabled: true },
    { id: 30, keyword: 'helo',                 answer: 'Helo kak! 👋 Senang banget bisa chat sama kakak 😊\n\nAda yang ingin ditanyakan tentang YahyaEduFarm? Kami agrowisata edukasi berbasis Masjid Ismuhu Yahya di Kalimantan Barat — tempatnya sejuk, cocok buat piknik sambil belajar. Ada wisata panen, edukasi hidroponik, outbound, dan gathering.\n\nTanya aja ya kak, siap bantu 🙏', enabled: true },
...
const DEFAULT_FAQ_BLASTING = [
    ...
    { id: 22, keyword: 'halo',        answer: 'Halo kak! 👋 Senang sekali bisa ngobrol sama kakak 😊\n\nAda rencana untuk berkunjung ke YahyaEduFarm? Kami adalah agrowisata edukasi berbasis Masjid Ismuhu Yahya di Kalimantan Barat — tempatnya asri, cocok untuk keluarga, sekolah, dan komunitas. Ada wisata panen, edukasi hidroponik, outbound, dan gathering.\n\nSilakan tanya apa saja ya kak, dengan senang hati kami bantu 🙏', enabled: true },
    { id: 23, keyword: 'selamat pagi', answer: 'Selamat pagi kak! 🌤️ Semoga hari kakak penuh berkah 😊\n\nAda rencana untuk berkunjung ke YahyaEduFarm? Yuk lihat program kami: wisata panen, edukasi hidroponik, outbound, dan gathering — semua berbasis Masjid Ismuhu Yahya di Kalimantan Barat.\n\nAda yang bisa kami bantu hari ini? 🙏', enabled: true },
    { id: 24, keyword: 'selamat siang', answer: 'Selamat siang kak! ☀️ Semoga hari kakak menyenangkan 😊\n\nAda rencana untuk berkunjung ke YahyaEduFarm? Yuk lihat program kami: wisata panen, edukasi hidroponik, outbound, dan gathering — semua berbasis Masjid Ismuhu Yahya di Kalimantan Barat.\n\nAda yang bisa kami bantu? 🙏', enabled: true },
    { id: 25, keyword: 'selamat malam', answer: 'Selamat malam kak! 🌙 Terima kasih sudah menghubungi YahyaEduFarm 😊\n\nAda rencana untuk berkunjung? Kami punya program wisata panen, edukasi hidroponik, outbound, dan gathering — berbasis Masjid Ismuhu Yahya di Kalimantan Barat.\n\nSilakan tanya-tanya dulu ya kak, dengan senang hati 🙏', enabled: true },
    { id: 26, keyword: 'helo',        answer: 'Helo kak! 👋 Senang banget bisa chat sama kakak 😊\n\nAda yang ingin ditanyakan tentang YahyaEduFarm? Kami agrowisata edukasi berbasis Masjid Ismuhu Yahya di Kalimantan Barat — tempatnya sejuk, cocok buat piknik sambil belajar. Ada wisata panen, edukasi hidroponik, outbound, dan gathering.\n\nTanya aja ya kak, siap bantu 🙏', enabled: true },
];
